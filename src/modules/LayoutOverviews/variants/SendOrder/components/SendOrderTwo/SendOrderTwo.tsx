...
interface SendOrderTwoProps {}

const SendOrderTwo: React.FC<SendOrderTwoProps> = () => {
  return (
    <OverviewGrid className="grid-cols-3 grid-rows-5">
      ...
      <OverviewBox className="row-[2/4] col-[2/3]">گزارش سفارشات در حال خرید</OverviewBox>
